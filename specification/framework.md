...
| --- | --- | --- | --- | --- |
| *Ingest it* | ING-1 | L1 | Use public package managers trusted by your organization, i.e. NuGet.org, npmjs.com | Your organization benefits from the inherent security provided by the package manager |
| | ING-2 | L1 | Use an OSS binary repository manager solution, i.e. JFrog Artifactory, Azure Artifacts | Caches a local copy of the OSS artifact and protects against [left-pad](https://www.theregister.com/2016/03/23/npm_left_pad_chaos/) incidents, enabling developers to continue to build even if upstream resources are unavailable |
